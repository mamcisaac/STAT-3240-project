...
1. **Project data:** Propose a data set for your project. `r hint_1`. After you submit your data proposal, you will get peer and instructor feedback that you should incorporate in your project proposal.
1. **Project proposal:** test Ensure you can work with your data in R by performing an exploratory data analysis. `r hint_2` After you submit your project prosal, you will get peer and instructor feedback that you should incorporate in your initial project submission. 
1. **Initial project submission:** Make an initial submission of your project. You will skip some of the sections for now and only complete them after we have covered inference for regression in class. After you submit your work, you will get peer and instructor feedback that you should incorporate in your final report. 
1. **Final project submission:** Incorporate your feedback from the intial project submission phase, complete the remaining sections, and resubmit your project. The majority of your grade will come from this final project submission.

After phases 2,3, and 4, you will engage in **Peer review** and provide feedback to several other groups. Your group will be expected to incorporate the feedback it receives when working on the next phase of the project. 
...
* Get a sense for the requirements of this project phase by reading only the following sections of this possible [final project submission](static/term_project/resubmission_example.html){target="_blank"} `r submission_will_differ`: 
...
After your group submits its data, proposal, and initial project report, each group member will, individually, be required to provide feedback to several other groups. That feedback will be assessed and, along with feedback given by the instructor and TAs, should be incorporated in subsequent submissions. Each group submission and individual peer review will count toward your individual final grade, with most of the weight being placed on the quality of the final report. Remember that you will all be held accountable for your contributions in peer evaluations; you will submit your project as a group, but you will receive an individual grade based on your contributions as well as the quality of your group's work. 