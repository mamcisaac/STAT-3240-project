...
1. [**Final submission-poster presentation:**](#resubmission) Incorporate your feedback from the initial project submission phase and create a final research poster. The majority of your grade will come from this final project submission.
...
* Reporter -- Leads the actual writing of the reports.
...
* [Example project proposal 1](static/term_project/proposal_example.html){target="_blank"}
...
* a research poster (the next assignment). 
...
In creating your research poster (next assignment), you will need to explain what changes you made in response to your own self-reflection and the feedback to your video presentation. 
...
# Research Poster {#resubmission}

The goal of this assignment is to perform create a research poster for your group project.
...
Your poster will be judged based on the criteria outlined for the [International Statistical Literacy Project](https://iase-web.org/islp/documents/Poster_Competition_2024-2025/Criteria%20to%20be%20judget%202024%20(1).pdf?1709805317)

## What to submit

`r only_group_leader`

1. An R Markdown file containing your reproducible poster file (use the `posterdown` package).
1. The corresponding knitted electronic poster file.
